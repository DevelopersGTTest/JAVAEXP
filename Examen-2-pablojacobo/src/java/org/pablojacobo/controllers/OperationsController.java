...
public class OperationsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //varify user
            this.statusLogin = Users.getInstance()
                .authValid(this.username, this.pass);
            
            //Render a view calculator
            if( this.statusLogin == true ){
                 RequestDispatcher view = request
                    .getRequestDispatcher("calculadora.html");      
            ...
            System.out.println(" [STATUS ] ::::: " + this.statusLogin  );
        }
    }
